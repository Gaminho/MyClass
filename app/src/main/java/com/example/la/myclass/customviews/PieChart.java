...
public class PieChart extends ViewGroup {
    ...
    private void init() {
        ...
        if (this.isInEditMode()) {
            ...
            addItem("Annabelle", 3, res.getColor(R.color.them700));
            addItem("Brunhilde", 4, res.getColor(R.color.them900));
            addItem("Carolina", 2, res.getColor(R.color.them100));
            addItem("Dahlia", 3, res.getColor(R.color.them300));
            addItem("Ekaterina", 1, res.getColor(R.color.them600));
        }
